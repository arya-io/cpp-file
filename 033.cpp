...
// Vectors are the dynamic arrays which have the ability to resize itself automatically when an element is inserted or deleted.
// The size of the arrays cannot be altered at run time but vectors overcomes this disadvantage of the arrays.
